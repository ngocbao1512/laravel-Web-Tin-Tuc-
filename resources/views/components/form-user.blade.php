                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-3 col-sm-4">
                                    ...
                                    <input id="first_name" name="first_name" type="text" value="@yield('firstname')"  placeholder="first name" class="form-control validate" required/>
                                </div>
                                <div class="col-xs-3 col-sm-4">
                                    ...
                                    <input id="middle_name" name="middle_name" type="text" value="@yield('middlename')" placeholder="middle name" class="form-control validate" required/>
                                </div>
                                <div class="col-xs-3 col-sm-4">
                                    <label for="lastname">
                                        <b>
                                    ...
                                    <input id="last_name" name="last_name" type="text" value="@yield('lastname')"  placeholder="last name" class="form-control validate" required/>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input id="email" name="gmail" type="email" value="@yield('email')"  placeholder="Enter Gmail" class="form-control validate" required/>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <label for="user_name">
                                        <b>
                                    ...
                                    <input id="user_name" name="username" type="text" value="@yield('username')"  placeholder="User Name" class="form-control validate" required/>
                                </div>
                            </div>
                        </div>
                        <hr>
