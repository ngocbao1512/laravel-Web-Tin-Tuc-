            ...
            <div class="row" > 
                <div class="col-12" style="min-height: 70vh">
                    <div class="float-center">
                        <p class="tm-block-title d-inline-block float-center" style="font-size: 30px">Edit User</p>
                    </div>
                        ...
                        <form class="tm-edit-product-form" enctype="multipart/form-data">
                            ...
                            <div class="row tm-edit-product-row">
                                ...
                                <button  type="button" class="btn btn-primary btn-block text-uppercase "
                                 ...
                                 onclick="saveData(this,'update','do you want to update this user',BASE_CRUD._userid)"
                                 >
                                 Edit User
                                </button>
                            </div>
