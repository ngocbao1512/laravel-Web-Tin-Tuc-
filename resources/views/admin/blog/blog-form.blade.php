                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <input id="title_blog" name="title" type="text"  placeholder="{{trans('blog.title')}}" class="form-control validate" required/>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <textarea class="form-control validate" style="resize: none" class="form-control" cols="30" rows="20" placeholder="{{trans('blog.content')}}" name="content" id="content_blog"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            @else
                                <button  type="button" class="btn btn-primary btn-block text-uppercase "
                                    style="color:white;background-color:rgb(24 89 230);"
                                    onclick="saveData(this,'{{trans('user.do_you_want.update')}}',{{$blogId}})"
                                >
                                {{trans('blog.edit-.blog')}}
                                </button>
                            @endif
