                   ...
                   <div class="row tm-edit-product-row">
                       ...
                       <div class="col-xl-6 col-lg-6 col-md-12">
                           <div class="form-group">
                               ...
                               <textarea class="form-control validate" style="resize: none" class="form-control" cols="30" rows="80" placeholder="{{trans('blog.content')}}" name="content" id="content-{{$blogId}}">{{$content}}</textarea>
                       ...
                       <div class="col-12">
                           @if ($action =='create')
                               <button  type="button" class="btn btn-primary btn-block text-uppercase "
                                   ...
                                   onclick="saveData(this,'{{trans('blog.do_you_want.create')}}',{{$blogId}})"
                               >
                               {{trans('blog.create-.blog')}} 
                               </button>
                           @else
