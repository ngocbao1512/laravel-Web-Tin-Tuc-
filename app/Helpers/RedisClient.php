...
class RedisClient
{
    ...
    public function HashDeleteField($key, $field)
    {
        $this->cmd('HDEL', $key, $field)->set();
    }
...
// $redis = new RedisClient('127.0.0.1',6379, "",0);
// echo 'locktake';
// echo  $redis->LockTake("lockkey","dudu", 30000);
// echo $redis->LockRelease('lockkey','dudu');
// echo  $redis->LockTake("lockkey","dudu", 30000);
